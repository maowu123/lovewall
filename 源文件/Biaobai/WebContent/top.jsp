		...
		<div class="container-fluid">
			...
			<div style="float: left;" id="navbar-nav">
				<ul class="nav navbar-nav">
					<li><a href="index.jsp" target="_top" style="color: #000;">表白墙</a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<%=request.getContextPath() %>/ShowMore/biaobaiMore.jsp?type=3" target="_top">为自己脱单</a></li>
							<li><a href="<%=request.getContextPath() %>/ShowMore/biaobaiMore.jsp?type=4" target="_top">给舍友脱单</a></li>
							<li class="divider"></li>
			...
			<div style="float: right;" id="navbar-nav">
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" style="color: #000;"> <!--<img
							src="<%=user.getHeadphoto()%>"
							 width="40px" height="40px" />  -->
							 <img
							src="<%=request.getContextPath() %>/img/user.jpg"
							 width="40px" height="40px" />
							  <b
							class="caret"></b>
					</a>
						<ul class="dropdown-menu">
							<li><a href="#" target="_top">个人主页</a></li>
							<li><a href="<%=request.getContextPath() %>/update.jsp" target="_top">修改信息</a></li>
							<li><a href="#" target="_top">我的消息【】</a></li>
							<li class="divider"></li>
							<li><a
