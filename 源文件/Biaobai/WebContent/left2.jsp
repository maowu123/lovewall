...
#md7 {
  background: -webkit-linear-gradient(left top, #ffaad5 , #ffffff,  #ffffff); 
  background: -o-linear-gradient(bottom right, #ffaad5,  #ffffff,  #ffffff); 
  background: -moz-linear-gradient(bottom right, #ffaad5,  #ffffff,  #ffffff); 
  background: linear-gradient(to bottom right, #ffaad5 ,  #ffffff,  #ffffff); 
}
</style>
</head>
<body id="md7">
